...
def create_chromosomes_plot(args, gene_positions_b1: dict, gene_positions_b2: dict, gene_positions_sample: dict, cytoband_file: str, plot_name: str, step_on: int = 500000,
							logger=None):
