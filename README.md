...
This software is designed to perform somatic variant selection, comparing exomes from a cohort of cancer patients before/after treatment. It also includes a filter module to help you removing remaining germline or non driver mutations.
